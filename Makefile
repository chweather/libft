...
#    Updated: 2017/10/12 01:31:47 by cweather         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c \
	ft_memdel.c ft_memmove.c ft_memchr.c ft_memcmp.c ft_memalloc.c \
	ft_atoi.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
	ft_isprint.c ft_itoa.c ft_putchar.c ft_putchar_fd.c \
	...
	ft_fabs.c ft_countwords.c ft_lstcount.c ft_splitdel.c ft_lstrev.c \
